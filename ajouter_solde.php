                ...
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-auto">
                        <div class="breadcrumbs"><a href="index.php">Accueil </a><span><i
                                    class="ri-arrow-right-s-line"></i></span><a href="creer-creance.php">Ajouter solde</a></div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Ajouter solde </h4>
                        </div>
                        <div class="card-body">
                            <form class="invoice-form" action="app/ajouter_solde.php" method="POST" enctype="multipart/form-data">
                                    <hr>
                                    <div class="row">
                                    ...
                                    <div class="add-reset d-flex justify-content-between">
                                        ...
                                        <button class="btn btn-primary" name="ajouter_solde">
                                            <span><i class="bi bi-plus"></i></span>Ajouter
                                        </button>
                                    </div>
                            </form>
                        </div>
