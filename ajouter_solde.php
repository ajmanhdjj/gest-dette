                ...
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-auto">
                        <div class="breadcrumbs"><a href="/dashboard">Accueil </a><span><i
                                    class="ri-arrow-right-s-line"></i></span><a href="/creances/nouvelle">Ajouter solde</a></div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="invoice-form" action="/solde/ajouter/action" method="POST" enctype="multipart/form-data">
                                    <hr>
                                    <div class="row">
